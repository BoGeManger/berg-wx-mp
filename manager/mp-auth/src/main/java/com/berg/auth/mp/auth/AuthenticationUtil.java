...
public class AuthenticationUtil {
    ...
    public MpUserInfoVo getUserinfo() {
        try{
            return JSONUtil.toBean(getField("userinfo"), MpUserInfoVo.class);
        }catch (Exception ex){
            return null;
        }
    }
    ...
    public String getOauthAccessToken(){
        return getField("oauthAccessToken");
    }
     ...
     * @return
     */
    public String sign(String appId, String openId, String unionId, String memberId, Integer maBindId, LocalDateTime createTime, LocalDateTime modifyTime, MpUserInfoVo userInfoVo, String oauthAccessToken) {
        try {
            openId = StringUtils.lowerCase(openId);
            Algorithm algorithm = Algorithm.HMAC256(oauthAccessToken);
            return JWT.create()
                    ...
                    .withClaim("oauthAccessToken", oauthAccessToken)
                    .sign(algorithm);
        } catch (Exception e) {
            return null;
        }
